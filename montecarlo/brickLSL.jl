...
function get_brickGMSL_zip(gmslfile::String, rcp::Union{String, Number})
    ...
    filepath_temp = joinpath(results_dir,"projections_csv/RCP$(rcp)/projections_temperature_RCP$(rcp)_sneasybrick.csv")
    ...
    brTemp = Matrix(CSV.read(filepath_temp,DataFrame))
